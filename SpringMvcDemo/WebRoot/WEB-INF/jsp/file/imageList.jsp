...
#page ul li a{
  ...
  <body>
    ...
    <button type="button" style="width:100%;height:10%;" onclick="uploadImage()">上传图片</button>
	 ...
	 <div class="content">
	<form id="imageform" action="<%=path%>/file/imageList" >
...
<!--         <li><img data-src="images/111.gif" src="images/default.png" alt="默认图片"></li> -->
        ...
        <li><img data-src="uploadimage/${image.url}" src="images/default.gif" alt="${image.title}"></li>
      	 </c:forEach>
    ...
    <script>
        ...
        function uploadImage(){
        	window.location.href="<%=path%>/file/toUploadImage";
        }
        
        function backtoHome(){
        	window.location.href="<%=path%>/goForBlog";
        }
