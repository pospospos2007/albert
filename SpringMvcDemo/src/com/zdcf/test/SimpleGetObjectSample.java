...
public class SimpleGetObjectSample {
    ...
    private static String endpoint = "http://barlolo.oss-cn-hongkong.aliyuncs.com/";
    private static String accessKeyId = "LTAIDYqPtix8XiOG";
    private static String accessKeySecret = "Oz8swP6Xgx4b2Jgaqs11DV30XumbdG";
